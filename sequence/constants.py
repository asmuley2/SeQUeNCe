...
ALL_C_CONNECT: Final = "cconnections"    # bidirectional classical connections
...
QLAN_ORCHESTRATOR: Final = "QlanOrchestratorNode"
QLAN_CLIENT: Final = "QlanClientNode"
CONTROLLER: Final = "Controller" # Unused for now.

# Connection Type Identifiers
MEET_IN_THE_MIDDLE: Final = "meet_in_the_middle"
